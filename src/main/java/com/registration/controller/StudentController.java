...
public class StudentController {
	...
	public ResponseEntity<?> registerCourse(@PathVariable(value = "studentid") Long studentId,@RequestParam String courseId ) {
		
		Student student = studentRepository.findById(studentId)
				.orElseThrow(() -> new ResourceNotFoundException("Student", "id", studentId));
		
		Course selectedCourse = courseRepository.findById(Long.valueOf(courseId)).orElseThrow(()-> new ResourceNotFoundException("Course","courseId",courseId));
